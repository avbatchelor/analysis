...
sensory_gain_range = [3.0 1.0];wii = linspace(sensory_gain_range(1),sensory_gain_range(2),numb_of_segments); 
...
%%%%%% MAIN OUTPUT OF THE MODEL
 ethogram_binary=winmat; % This is the ethogram: rows: "active cleaning module"; cols: "time"; 
 % The bottom 2 rows represent the front and back leg rubbing if
 % implemented
 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 
%%%%%%%%%%%%% PLOT ETHOGRAM IN DIFFERENT COLORS %%%%%%%%%%%%%%%
